...
import org.webflow.order.OrderFlowHandler;
...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
	...
	public void addViewControllers(ViewControllerRegistry registry) {
		...
		registry.addViewController("/registrationForm");
		registry.addViewController("/registerSuccess");
	}
	...
	@Bean(name="products/ordering")
	public OrderFlowHandler OrderingFlowHandler() {
